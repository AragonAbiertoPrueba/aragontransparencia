...
try:
    while(1):
        ...
        for tweet in tw.Cursor(API.search,q="*",count=1500, geocode="41.650154,-0.885943,135km").items(1500):
            try:
        ...
        for tweet in tw.Cursor(API.search,q="*",count=1500,geocode="42.134404, -0.407515,90km").items(1500):
            try:
                print [tweet.created_at, tweet.text.encode('utf-8')]
                csvWriter.writerow([tweet.created_at, tweet.text.encode('utf-8')])
            except Exception as e:
        ...
        for tweet in tw.Cursor(API.search,q="*",count=1500,geocode="40.344583, -1.107039,70km", ).items(1500):
            try:    
                print [tweet.created_at, tweet.text.encode('utf-8')]
                csvWriter.writerow([tweet.created_at, tweet.text.encode('utf-8')])
            except Exception as e:
        ...
        if(felicidad<=100 and felicidad> 60):  
            selector_imagen="9"
        elif(felicidad<=60 and felicidad>57):  
            selector_imagen="8"
        elif(felicidad<=57 and felicidad>55):  
            selector_imagen="7"
        elif(felicidad<=55 and felicidad>53):  
            selector_imagen="6"       
        elif(felicidad<=53 and felicidad>52):  
            selector_imagen="5"
        elif(felicidad<=52 and felicidad>51):  
            selector_imagen="4"
        elif(felicidad<=51 and felicidad>50):  
            selector_imagen="3"
        elif(felicidad<=50 and felicidad>49):  
            selector_imagen="2"
        elif(felicidad<=49 and felicidad>48):  
            selector_imagen="1"
        elif(felicidad<=48 and felicidad>0):   
            selector_imagen="0"
        else:                                  
            selector_imagen="66"
        ...
        selector = open ('selector_v0.csv','a')
